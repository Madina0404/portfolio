...
const Navbar = () => {
  return (
    <nav className='flex gap-3 mx-[20px] my-5 text-[20px] border-b-2 border-purple-500 py-3'>
      <NavLink className={'border-b-2 border-transparent text-purple-500'} to={"/"}>Home</NavLink>
